...
#define VPHELPER(VPADR, RXFPTR, TXFPTR ) { .VP=VPADR, .memadr=nullptr, .size=sizeof(nullptr),\
...
const struct DGUS_VP_Variable ListOfVP[] PROGMEM = {
  ...
  VPHELPER(VP_T_E0_Is, nullptr, SET_VARIABLE(getActualTemp_celsius, E0)),
  VPHELPER(VP_T_E0_Set,
           GET_VARIABLE(setTargetTemp_celsius, E0),
           SET_VARIABLE(getTargetTemp_celsius, E0)),

  VPHELPER(VP_T_Bed_Is, nullptr, SET_VARIABLE(getActualTemp_celsius, BED)),
  VPHELPER(VP_T_Bed_Set, 
           GET_VARIABLE(setTargetTemp_celsius, BED),
           SET_VARIABLE(getTargetTemp_celsius, BED)),
  ...
  VPHELPER(VP_MOVE_X,
           GET_VARIABLE(setAxisPosition_mm, X, 10),
           SET_VARIABLE(getAxisPosition_mm, X, 10)),
  VPHELPER(VP_MOVE_Y,
           GET_VARIABLE(setAxisPosition_mm, Y, 10),
           SET_VARIABLE(getAxisPosition_mm, Y, 10)),
  VPHELPER(VP_MOVE_Z,
           GET_VARIABLE(setAxisPosition_mm, Z, 10),
           SET_VARIABLE(getAxisPosition_mm, Z, 10)),    
  ...
  VPHELPER(VP_E0_PID_P, nullptr,
          SET_VARIABLE(getPIDValues_Kp, E0)),
  VPHELPER(VP_E0_PID_I, nullptr,
          SET_VARIABLE(getPIDValues_Ki, E0)),
  VPHELPER(VP_E0_PID_D, nullptr,
          SET_VARIABLE(getPIDValues_Kd, E0)),
